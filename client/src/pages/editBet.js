            ...
            <div>
                ...
                <div className="container">
                    ...
                    <form onSubmit={event => this.editBet(event)}>
                        <Input type={'text'} labelName={'Task'} labelCol='3' inputCol='9' inputName={'task'} placeholder={'Task'} onChange={event => this.inputChange(event, 'task')}/>
                        ...
                        <Input type={'text'} labelName={'Bet Acceptor'}  labelCol='3' inputCol='9' inputName={'acceptor'} placeholder={'Acceptor Name'} onChange={event => this.inputChange(event, 'acceptor')}/>

            ...
            <div className="container">
                ...
                <section className="demo row">
                    ...
                    <div className="col-6">
                        ...
                        <p>Just kidding</p>
                        <p>TaskBet makes it easy to make your bets official. Just fill out a simple form, provide your friend (or foe)'s email address and we'll let you know how to get started.</p>                        <p>Once the bet has been accepted, it's time to get cracking! You or your friend must complete the task at hand and submit photo evidence before the deadline.</p>
